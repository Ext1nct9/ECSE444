...
int main(void)
{
  ...
  while (1)
  {
    ...
    // Update DAC values
      ...
      //HAL_DAC_SetValue(&hdac1, DAC_CHANNEL_2, DAC_ALIGN_12B_R, dac_buffer_tri[i]);
      //HAL_DAC_SetValue(&hdac1, DAC_CHANNEL_1, DAC_ALIGN_12B_R, dac_buffer_saw[i]);
